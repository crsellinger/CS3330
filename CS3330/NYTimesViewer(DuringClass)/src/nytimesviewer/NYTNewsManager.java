...
public class NYTNewsManager {
    ...
    // sample url:
    //private String urlString = "http://api.nytimes.com/svc/search/v2/articlesearch.json?q=Microsoft&api-key=6bb2c6f09bb14a3183db503c5d8030";
   
    // NOTE!!  The api key below is Professor Wergeles' api key.  If you build an app that uses the New York Times API get your own api key!!!!!  
    //          Get it from: http://developer.nytimes.com
    ...
    private final String apiKey = "lCXbAfqpp1tgLJ4W0o5QpQoxjn7EZ0Qs";
    ...
    public void load(String searchString) throws Exception {
        ...
        //encode user input string
        
        urlString = baseUrlString + "?q=" + URLEncoder.encode(searchString, "UTF-8") + "&api-key=" + apiKey;
