...
public class NewsViewerController implements Initializable {
    ...
    public void ready(Stage stage) {
        ...
        //sets text field to default and loads articles
    ...
    private void loadNews() {
        ...
        //loads web page with url formed in newsManager function
        try {
    ...
    private void displayAboutAlert() {
        ...
        textArea.appendText("Nick's api-key is used in this application.  If you develop your own application get your own api-key from the New York Times.");
        textArea.setEditable(false);
        textArea.setWrapText(true);
        textArea.setMaxWidth(Double.MAX_VALUE);
        textArea.setMaxHeight(Double.MAX_VALUE);
