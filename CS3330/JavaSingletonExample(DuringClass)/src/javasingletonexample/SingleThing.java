...
public class SingleThing {
    ...
    //1) private constructor, no instances can be created outside the class
    private SingleThing(){
        
    }
    
    //2) private inner class, this is static member which holds the single instance variable,
    //  nested class
