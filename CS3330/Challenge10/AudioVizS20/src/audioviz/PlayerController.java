...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        visualizers.add(new Crsb74AudioViz());
    ...
    private void handleReady() {
        ...
        lengthText.setText(String.format("%.0f secs", duration.toSeconds()));
    ...
    private void handleVisualize(double timestamp, double duration, float[] magnitudes, float[] phases) {
        ...
        currentText.setText(String.format("%.0f secs", ct.toSeconds()));
