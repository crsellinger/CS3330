...
public class Person implements java.io.Serializable {
    ...
    //Serialization (convert from object to json string)
    public String toJsonString() {
        //had to import json-simple.jar library for JSONObject
    ...
    //Deserialization (convert from json string to object)
    public void initFromJsonString(String jsonString) {
        ...
        JSONObject jsonObj;
        try {
            //had to import json-simple.jar library for JSONValue
